...
export default function StoryCard(props) {
    ...
    const trackOnMouseUp = () => {
        ...
        document
            ...
            .appendChild(document.createElement(<BothWays />));
    };
    ...
    return (
        <>
            <div
                className={"story-card " + props.className}
                onMouseEnter={() => trackOnMouseEnter()}
                        ...
                        <svg
                            ...
                            <g id="Layer_2" data-name="Layer 2">
                                <g id="Layer_1-2" data-name="Layer 1">
                                    <polygon
                                        className="cls-1"
                                        points="71.21 8.9 62.31 0 35.61 26.7 8.9 0 0 8.9 26.7 35.61 0 62.31 8.9 71.21 35.61 44.51 62.31 71.21 71.21 62.31 44.51 35.61 71.21 8.9"
                                    />
                                </g>
                            </g>
                        </svg>
                ...
                <div
                    className="content"
                    style={{ maxHeight: props.height + "vh" }}>
                            ...
                            <Grid container>
                                <Grid item xs={4}>
                                    ...
                                    <p className="paragraph">
                                        Previously studied Business Japanese at
                                        Foreign Trade University of Vietnam, yet
                                        somewhere along the line I realized that
                                        it was not the right path for me. So I
                                        enrolled into University of Greenwich
                                        and studied software engineering, mainly
                                        because I had been tinkering with
                                        computer since the age of 3.
                                    </p>
                                </Grid>
                                <Grid item xs={6}></Grid>
                            </Grid>
