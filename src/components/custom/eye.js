...
export default function FollowingEye(props) {
  ...
  return (
    <div className="eye-outer">
      <svg viewBox="0 -20 617.24 391" height={props.height}>
        <g stroke="black" strokeWidth={4.5} stroke-linecap="square">
          <path
            class="cls-1"
          ...
          <circle fill="#d6ff0a" class="eye-circle" cx="308.62" cy="175.5" r="42.58" ref={eye} />
        </g>
      </svg>
    </div>
  );
