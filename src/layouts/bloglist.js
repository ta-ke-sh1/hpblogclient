...
export default function BlogList() {
    ...
    const data = [
        ...
        {
            id: "C6SWVqebuMYzXTSguNTn",
            date: 1679204728,
            image: ["image4.jpg", "image2.jpg"],
            title: "What is Life?",
            content: "Lorem ipsum sit dolor",
            view_count: "12",
            tags: ["Thoughts", "Existential"],
            location: "Ha Noi",
        },
        {
            id: "bDmrRfHg2N0VfxTvZBp5",
            date: 1679240728,
            image: ["image3.jpg"],
            title: "Loren Ipsum Sit Dolor",
            content: "Lorem ipsum sit dolor",
            view_count: 12,
            tags: ["Daily", "Thoughts", "Life"],
            location: "Ha Noi",
        },
    ];
                ...
                <div className="custom-wrapper h-20 t-center">
                    ...
                    <div className="center-div w-40 mt-4">
                        <p>
                            ...
                            diam ullamcorper elementum. Vestibulum ut euismod
                            tortor.
                        </p>
                    </div>
                </div>
